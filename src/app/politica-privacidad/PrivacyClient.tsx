    ...
    <>
      ...
      <section id="datos">
        ...
        <ul>
          ...
          <li><strong>Datos de uso:</strong> páginas visitadas, acciones realizadas en la app, tiempo de sesión, dispositivo y navegador. Usamos esta información para mejorar el producto.</li>
          <li><strong>Datos de pago:</strong> procesados por proveedores certificados (Stripe). No almacenamos números de tarjeta en nuestros servidores.</li>
        </ul>
      </section>
      <section id="uso">
      ...
      <section id="compartir">
        ...
        <ul>
          ...
          <li><strong>OpenAI:</strong> generación de planes con IA (datos enviados de forma anonimizada).</li>
      ...
      <section id="derechos">
        ...
        <p>Para ejercer cualquiera de estos derechos, escríbenos a <a href="mailto:privacidad@refeit.app">privacidad@refeit.app</a>.</p>
      </section>
      <section id="cookies">
        <h2>7. Cookies y rastreo</h2>
        <p>Usamos cookies estrictamente necesarias para el funcionamiento del servicio (sesión, preferencias de idioma) y cookies analíticas anonimizadas. No usamos cookies publicitarias ni de terceros con fines de perfilamiento.</p>
      </section>
      <section id="menores">
      ...
      <section id="contacto">
        <h2>10. Contacto</h2>
        <p>Si tienes preguntas, dudas o reclamaciones sobre esta política, puedes escribirnos a <a href="mailto:privacidad@refeit.app">privacidad@refeit.app</a>. Responderemos en un plazo máximo de 30 días.</p>
      </section>
    </>
  );
}
    ...
    <>
      ...
      <section id="datos">
        ...
        <ul>
          ...
          <li><strong>Dados de uso:</strong> páginas visitadas, ações realizadas no app, tempo de sessão, dispositivo e navegador. Usamos essa informação para melhorar o produto.</li>
          <li><strong>Dados de pagamento:</strong> processados por provedores certificados (Stripe). Não armazenamos números de cartão em nossos servidores.</li>
        </ul>
      </section>
      <section id="uso">
      ...
      <section id="compartir">
        ...
        <ul>
          ...
          <li><strong>OpenAI:</strong> geração de planos com IA (dados enviados de forma anonimizada).</li>
      ...
      <section id="derechos">
        ...
        <p>Para exercer qualquer destes direitos, escreva-nos para <a href="mailto:privacidad@refeit.app">privacidad@refeit.app</a>.</p>
      </section>
      <section id="cookies">
        <h2>7. Cookies e rastreamento</h2>
        <p>Usamos cookies estritamente necessários para o funcionamento do serviço (sessão, preferências de idioma) e cookies analíticos anonimizados. Não usamos cookies publicitários nem de terceiros com fins de perfilamento.</p>
      </section>
      <section id="menores">
      ...
      <section id="contacto">
        <h2>10. Contato</h2>
        <p>Se tiver dúvidas ou reclamações sobre esta política, escreva-nos para <a href="mailto:privacidad@refeit.app">privacidad@refeit.app</a>. Responderemos em até 30 dias.</p>
      </section>
    </>
  );
}
