...
export const categoryColors: Record<MealCategory, {bg: string, text: string, dark: string, light: string}> = {
  ...
  lunchTarde: {bg: 'bg-green-100', text: 'text-green-800', dark: '#065F46', light: '#D1FAE5'},
  cena: {bg: 'bg-purple-100', text: 'text-purple-800', dark: '#5B21B6', light: '#EDE9FE'},
  general: {bg: 'bg-gray-100', text: 'text-gray-600', dark: '#4B5563', light: '#F3F4F6'}
};